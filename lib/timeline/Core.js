...
Core.prototype._create = function (container) {
  ...
  function onMouseWheel(event) {
    ...
    // let the browser handle scrolling otherwise ; vis.js' original scroll machinery
    // doesn't work reliably (very slow on Firefox, broken on Chrome depending on
    // context and I have 0 skill to report a bug / propose a patch :-( I couldn't
    // even figure out how to make a minimumal case for reproduction
    return true;
